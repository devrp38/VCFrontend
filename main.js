...
module.exports = __webpack_require__(/*! D:\ICT_FSD\Main Project\VCFrontend\src\main.ts */"zUnb");
...
class AuthService {
    ...
    teacherSignup(teacher) {
        return this.http.post('/api/auth/TsignUp', { 'teacher': teacher });
    }
    //teache login
    teacherLogin(teacher) {
        return this.http.post('/api/auth/Tlogin', { 'teacher': teacher });
    }
    //student signup
    studentSignup(student) {
        return this.http.post('/api/auth/SsignUp', { 'student': student });
    }
    //student login
    studentLogin(student) {
        return this.http.post('/api/auth/Slogin', { 'student': student });
    }
    //admin login
    adminLogin(admin) {
        return this.http.post('/api/admin/login', { 'admin': admin });
    }
    //admin services
    //list all students
    listStudents() {
        return this.http.get('/api/admin/listStudents');
    }
    //delete a student
    deleteStudent(id) {
        return this.http.delete('/api/admin/deleteStudent/' + id);
    }
    //list all teachers
    listTeachers() {
        return this.http.get('/api/admin/listTeachers');
    }
    //delete a teacher
    deleteTeacher(id) {
        return this.http.delete('/api/admin/deleteTeacher/' + id);
    }
}
...
class ClassesService {
    ...
    getClassTeacher(id) {
        return this.http.post('/api/class/teacherList', { 'id': id });
    }
    //Teacher Create Class
    createClass(classData) {
        return this.http.post('/api/class/create', { 'class': classData });
    }
    //get all classes
    getClasses() {
    ...
    enrollClass(classid, id) {
        return this.http.post('/api/class/enrollClass', { 'classid': classid, 'id': id });
    }
    //list all enrolled classes of a student
    getClassStudent(id) {
        return this.http.post('/api/class/studentlist', { 'id': id });
    }
    ...
    updateClass(classData) {
        ...
        return this.http.put('/api/class/update', classData);
    }
    //delete a class
    deleteClass(id) {
        return this.http.delete('/api/class/delete/' + id);
    }
    //Create a note (teacher)
    createNote(id, noteData) {
        return this.http.post('/api/class/createNote', { 'noteData': noteData, 'id': id });
    }
    //get notes of a class
    getNotes(classId) {
        return this.http.post('/api/class/getNotes', { 'classId': classId });
    }
    //delete a note
    deleteNote(id) {
        return this.http.delete('/api/class/deleteNote/' + id);
    }
    //create assignment
    createAssignment(id, assignmentData) {
        return this.http.post('/api/class/createAssignment', { 'id': id, 'assignmentData': assignmentData });
    }
    //get Assignments
    getAssignments(classId) {
        return this.http.post('/api/class/getAssignments', { 'classId': classId });
    }
    //delete Assignment
    deleteAssignment(id) {
        return this.http.delete('/api/class/deleteAssignment/' + id);
    }
    //submit assignment student
    submitAssignment(sid, asid, submission) {
        return this.http.post('/api/class/submitAssignment', { 'asid': asid, 'submission': submission, 'sId': sid });
    }
    //get single assignment details
    getAssignment(asid) {
        return this.http.post('/api/class/getAssignment', { 'asid': asid });
    }
    //get submissions of an Assignment
    getSubmissions(asid) {
        return this.http.post('/api/class/submissions', { 'asid': asid });
    }
    //get submission status by student
    getSubmissionStatus(asid, sid) {
        return this.http.post('/api/class/submissionStatus', { 'asid': asid, 'sid': sid });
    }
}
